	 ...
	 */
{
	...
	set_table_column (table_header, tbl_idx_bemerkungen,        "Bemerkungen",        "Seilrissübung");
	 ...
	 */
{
	...
	// Button/Text ersetzt wurde, beim nächsten überfahren mit dem cursor
	// wieder sichtbar. Möglicherweise ein Bug in sk_table::set_cell () oder
	// in QT.
