...
const QString MimeHeader::text_name_content_type="Content-Type";
const QString MimeHeader::text_name_content_disposition="Content-Disposition";


MimeHeader::MimeHeader (const QString &text, const QString &_name)
{
...
void MimeHeader::test (const QString &text, const QString &_name)
{
	if (_name.isEmpty ())
	...
	std::cout << "Out: [" << MimeHeader (text, _name) << "]" << std::endl;
}

void MimeHeader::test ()
{
