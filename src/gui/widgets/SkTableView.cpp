...
{
	// Don't use a syle sheet - is slow.
	// If we must, use a style sheet rather than a palette because a style may
	//ignore the palette, while a style sheet is guaranteed to be honored.
