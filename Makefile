...
startkladde_autogenerated: build/migrations.pro

templates=src/db/migration/migrations.h.erb src/db/migration/migrations_headers.h.erb src/db/schema/CurrentSchema.cpp.erb src/migrations.pro.erb version/version
