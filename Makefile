...
# autogenerate_files.rb. Therefore, only one of them is listed here, with all 
# templates as dependency.
# This should be changed: either add the files to version control, or update
# them one at a time

startkladde_autogenerated: build/CurrentSchema.cpp

templates=src/db/schema/CurrentSchema.cpp.erb version/version

build/CurrentSchema.cpp: $(templates) src/db/migrations src/db/migrations/current_schema.yaml
