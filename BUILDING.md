...
read on.
 ...
 git clone https://github.com/startkladde/startkladde
...
The source code can be retrieved from the
[github project](https://github.com/startkladde/startkladde)
...
-   [Visual C++ 2010 redistributable package](http://www.microsoft.com/en-us/download/details.aspx?id=5555)
...
On Windows, you have to compile the
[Qt MySQL plugin](https://sourceforge.net/p/startkladde/wiki/MysqlPlugin).
